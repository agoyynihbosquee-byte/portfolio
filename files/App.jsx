...
import './App.css'
import photoBase64 from './photo.js'
        ...
        <div className={`hero-wrap ${loaded ? 'in' : ''}`}>
          ...
          <div className="hr">
            <div className="photo-frame">
              ...
              <div className="pf-ring r1" /><div className="pf-ring r2" /><div className="pf-ring r3" />
              <div className={`pf-img-wrap ${imgLoaded ? 'loaded' : ''}`}>
                <img src={photoBase64} alt="Yoga Bima Anggara Putra"
                  className="pf-img" onLoad={() => setImgLoaded(true)} />
              </div>
